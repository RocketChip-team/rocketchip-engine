...
if __name__ == "__main__":
    ...
    player.light = FogLight(player, 300, 230)
    dupli = GameObject(127, 127, sheet, torchpal, 0, (1, 1), True, "p",
                        {"Move": open("Behaviours/PlayerMovement.py", "r").read()}, latency=20)
    dupli.sprite.addframe([[27]])
    dupli.sprite.addframe([[28]])
    dupli.sprite.addanimation("None",  indexes=[1, 2])
    dupli.light = FogLight(dupli, 200, 230)
